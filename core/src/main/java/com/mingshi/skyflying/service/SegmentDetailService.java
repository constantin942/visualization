...
// bin/kafka-consumer-groups.sh --bootstrap-server 10.0.107.49:9092 --group skyflying-consumer-group --reset-offsets --topic skywalking-segments --to-datetime 2022-06-29T08:00:00.000 --execute
