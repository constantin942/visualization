  ...
  public static void accumulateTimes(String threadName, String time) {
    try {
      ...
      if (0 == incrementAndGet % (10 * 10000)) {
        ...
        // log.info(" # StatisticsConsumeProcessorThreadQPS.accumulateTimes() # 各个线程的QPS = 【{}】【{}】。", JsonUtil.obj2String(statisticsConsumeProcessorThreadQPSMap), JsonUtil.obj2String(timeCountMap));
        atomicInteger.set(0);
      }
      timeCount(time);
