...
//  **/
// @Slf4j
// public class IoThreadConsumerByEventHandler implements EventHandler<IoThreadObjectNode> {
//
...
//   @Override
//   public void onEvent(IoThreadObjectNode ioThreadObjectNode, long l, boolean b) throws Exception {
//     try {
//       doOnEvent(ioThreadObjectNode);
//     } catch (Throwable e) {
//       log.error("# IoThreadConsumerByEventHandler.onEvent() # 将segment信息、及对应的索引信息和SQL审计日志信息在本地攒批和批量插入时 ，出现了异常。", e);
//     }
//   }
//
