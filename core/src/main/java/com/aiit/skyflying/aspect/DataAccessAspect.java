...
import com.aiit.skyflying.common.utils.AspectUtil;
import com.aiit.skyflying.common.utils.DateUtil;
...
public class DataAccessAspect {
   ...
   */
  private static final String EXECUTE_EXPR = "execution(* com.aiit.web.controller.SkyflyingController.*(..))";
