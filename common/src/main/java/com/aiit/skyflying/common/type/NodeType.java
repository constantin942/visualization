...
package com.aiit.skyflying.common.type;
...
public enum NodeType {
    ...
    public static NodeType valueOf(int value) throws Exception {
        switch (value) {
            case 0:
                return Normal;
            case 1:
            ...
            case 11:
                return Unrecognized;
            default:
                throw new Exception("Unknown NodeType value");
        }
    }
     ...
     */
    public static NodeType fromSpanLayerValue(SpanLayer spanLayer) throws Exception {
        switch (spanLayer) {
            case Unknown:
                return Normal;
            case Database:
            ...
            case UNRECOGNIZED:
                return Unrecognized;
            default:
                throw new Exception("Can't transfer to the NodeType. SpanLayer=" + spanLayer);
        }
    }
}
