package com.aiit.skyflying.common.reactor.thread;

import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.node.ObjectNode;
import com.aiit.skyflying.common.agent.AgentInformationSingleton;
import com.aiit.skyflying.common.config.GracefulShutdown;
...
import com.aiit.skyflying.common.report.Report;
        ...
        try {
            ...
            if (StringUtil.isNotBlank(listString)) {
                ...
                for (MsSegmentDetailDo msSegmentDetailDo : segmentDetailList) {
                    ...
                    // 对各个指标进行统计，前端页面需要用到；2022-10-14 17:29:03
