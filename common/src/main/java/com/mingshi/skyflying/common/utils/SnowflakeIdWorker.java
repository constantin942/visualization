...
public class SnowflakeIdWorker {
  ...
  private static Long getWorkId() {
    try {
      ...
      // 如果获取失败，则使用随机数备用
      return StringUtil.nextLong(0, 31);
    }
  }
   ...
   * @Author zhaoming
   * @Description 将long类型的id，转换为字符串类型的
   * @Date 09:48 2020/7/16
   * @Param []
   **/
  public static synchronized String generateStringId() {
